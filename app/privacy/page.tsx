      ...
      <Card className="mb-8 container">
        ...
        <CardContent className="space-y-6">
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
              <li>
                Unikalny identyfikator użytkownika (userID) pozyskiwany podczas
                logowania
              </li>
              <li>
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4">4. Podstawa Prawna</h2>
            <p className="text-muted-foreground">
              Przetwarzanie danych odbywa się na podstawie art. 6 ust. 1 lit. b
              RODO (przetwarzanie jest niezbędne do wykonania umowy) oraz art. 6
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              ...
              dla których zostały zebrane, nie dłużej jednak niż przez okres 12
              miesięcy od ostatniej aktywności użytkownika lub do momentu
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              ...
              bezpieczeństwo danych użytkowników poprzez stosowanie odpowiednich
              środków technicznych i organizacyjnych. Dostęp do danych mają
              wyłącznie osoby upoważnione i jedynie w zakresie niezbędnym do
